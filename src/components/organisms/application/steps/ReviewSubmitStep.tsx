...
export function ReviewSubmitStep({
  ...
  const getCompletionStatus = () => {
    const sections = [
      ...
      {
        name: "Documents",
        completed: !!(data.documents && Object.keys(data.documents).length > 0),
      },
            ...
            {data.permanentAddress && !data.isSameAsPermanent && (
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  {data.permanentAddress.postalCode}
                  <br />
            ...
            {data.currentCTC && (
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ₹{data.currentCTC.toLocaleString()}
                  </p>
                </div>
              </div>
            )}
            {data.expectedCTC && (
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <DollarSign className="h-4 w-4 text-muted-foreground" />
                  <p className="text-sm text-muted-foreground">
                    ₹{data.expectedCTC.toLocaleString()}
                  </p>
                </div>
              </div>
            )}
            ...
            {job.screeningQuestions.map((question) => (
              <div key={question.id} className="space-y-2">
                ...
                <div className="pl-4 border-l-2 border-muted">
                  <p className="text-sm text-muted-foreground">
                    {data.screeningAnswers?.[question.id] ||
                      "No answer provided"}
                  </p>
                </div>
              </div>
