...
export async function GET(request: NextRequest) {
  try {
    ...
    const jobs = await Job.find(query)
      ...
      .skip((page - 1) * limit)
      .limit(limit)
      .select('title company department location description skills experienceLevel employmentType salary benefits featured createdAt updatedAt applicationDeadline')
      .lean();
